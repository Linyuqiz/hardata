use crate::adapters::outbound::transport::pool::TcpConnectionPool;
...
impl TcpClient {
    ...
    pub fn pool_status(&self) -> Option<crate::adapters::outbound::transport::pool::PoolStatus> {
...
pub enum PooledTcpConnection {
    Pooled(
        deadpool::managed::Object<crate::adapters::outbound::transport::pool::TcpConnectionManager>,
    ),
    Direct(TcpStream),
}
