...
pub struct LocalCdcResult {
    pub chunks: Vec<crate::shared::cdc::ChunkEntry>,
    pub mtime: i64,
    pub file_size: u64,
}
...
pub async fn check_local_cdc(
    ...
    dest_path: &str,
    chunk_index: Option<&std::sync::Arc<crate::application::sync::engine::CDCResultCache>>,
        ...
        match cache.get(dest_path, mtime, file_size) {
            Ok(Some(cached)) => {
                ...
                cached
                    .chunks
                    .into_iter()
                    .map(|ci| crate::shared::cdc::ChunkEntry {
                        offset: ci.offset,
...
async fn compute_cdc(
    config: &SchedulerConfig,
    dest_file_path: &Path,
) -> Result<Vec<crate::shared::cdc::ChunkEntry>> {
...
fn save_to_cache(
    ...
    dest_path: &str,
    chunks: &[crate::shared::cdc::ChunkEntry],
    mtime: i64,
    file_size: u64,
) {
    let cache_chunks: Vec<crate::application::sync::engine::ChunkInfo> = chunks
        .iter()
...
pub fn match_weak_hashes(
    ...
    local_chunks: &[crate::shared::cdc::ChunkEntry],
) -> WeakHashMatchResult {
