use crate::adapters::outbound::transport::bandwidth::NetworkQuality;
...
use crate::shared::compression::CompressionStrategy;
use crate::shared::constants::{DEFAULT_QUIC_BIND_ADDR, DEFAULT_TCP_BIND_ADDR};
...
pub struct SchedulerConfig {
    ...
    pub global_index: Option<Arc<crate::application::sync::engine::ChunkIndex>>,
}

impl Default for SchedulerConfig {
    fn default() -> Self {
        use crate::shared::cdc::{
...
pub struct ConnectionPool {
    ...
    pub protocol: Option<crate::adapters::outbound::transport::eyeballs::TransportProtocol>,
    pub quic_client: Option<QuicClient>,
    pub tcp_client: Option<TcpClient>,
    pub health_checker: Option<Arc<crate::adapters::outbound::transport::health::HealthChecker>>,
